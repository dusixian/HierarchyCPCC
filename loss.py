...
from emd.emd_methods import OTEMDFunction, SK, SlicedWasserstein_np, compute_flow_symmetric
...
class CPCCLoss(nn.Module):
    ...
    def forward(self, representations, target_fine):
        ...
        if self.is_emd > 0:
            ...
            if self.is_emd == 1 or self.is_emd == 2:
            ...
            if not combidx:
                ...
                raise Exception("wrong EMD methods!")
